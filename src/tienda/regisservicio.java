...
public class regisservicio {
   ...
   public static void limpieza() {
    ...
    System.out.println("\n------------- DATOS DEL PRODUCTO ----------------");
    // %-10s significa: String alineado a la izquierda con 10 espacios
    System.out.printf("%-10s%-20s%-10s%-10s%n", "ID", "Nombre", "Precio", "Cantidad");//Los numeros es para aliner la columna
    System.out.println("--------------------------------------------------");
    ...
    private static void imprimir_folio(String folio) {
        // Buscamos el folio en el diccionario global
